...
const createPoolConfiguration = (connectionUri, clientConfiguration) => {
  const poolConfiguration = (0, _pgConnectionString.parse)(connectionUri); // @see https://node-postgres.com/api/pool
  ...
  if (clientConfiguration.connectionTimeout === 'DISABLE_TIMEOUT') {
    ...
    _Logger.default.warn('connectionTimeout=0 sets timeout to 0 milliseconds; use connectionTimeout=DISABLE_TIMEOUT to disable timeout');
...
var _default = createPoolConfiguration;
